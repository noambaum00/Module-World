...
namespace ModuleWorld_Digital {
	...
	export function dht11value(dht11type: DHT11Type, value_DNum: mwDigitalNum): number {
		let dht11pin;
		switch (value_DNum) {
			case mwDigitalNum.P0P1:
				dht11pin = DigitalPin.P0;
			case mwDigitalNum.P2P3:
				dht11pin = DigitalPin.P2;
			case mwDigitalNum.P3P4:
				dht11pin = DigitalPin.P3;
			case mwDigitalNum.P4P5:
				dht11pin = DigitalPin.P4;
			case mwDigitalNum.P6P7:
				dht11pin = DigitalPin.P6;
			case mwDigitalNum.P8P9:
				dht11pin = DigitalPin.P8;
			case mwDigitalNum.P10P11:
				dht11pin = DigitalPin.P10;
			case mwDigitalNum.P12P13:
				dht11pin = DigitalPin.P12;
			case mwDigitalNum.P14P15:
				dht11pin = DigitalPin.P14;
			case mwDigitalNum.P1P10:
	...
	export function Ultrasonic(value_DNum: mwDigitalNum): number {
		...
		if (value_DNum == 1) {
			Trig = DigitalPin.P0;
			Echo = DigitalPin.P1;
		} else if (value_DNum == 2) {
			Trig = DigitalPin.P2;
			Echo = DigitalPin.P3;
		} else if (value_DNum == 3) {
			Trig = DigitalPin.P3;
			Echo = DigitalPin.P4;
		} else if (value_DNum == 4) {
			Trig = DigitalPin.P4;
			Echo = DigitalPin.P5;
		} else if (value_DNum == 5) {
			Trig = DigitalPin.P6;
			Echo = DigitalPin.P7;
		} else if (value_DNum == 6) {
			Trig = DigitalPin.P8;
			Echo = DigitalPin.P9;
		} else if (value_DNum == 7) {
			Trig = DigitalPin.P10;
			Echo = DigitalPin.P11;
		} else if (value_DNum == 8) {
			Trig = DigitalPin.P12;
			Echo = DigitalPin.P13;
		} else if (value_DNum == 9) {
			Trig = DigitalPin.P14;
			Echo = DigitalPin.P15;
		} else if (value_DNum == 10) {
			Trig = DigitalPin.P1;
			Echo = DigitalPin.P10;
		}
...
namespace ModuleWorld_Analog {
	...
	export function Light(value_ANum: mwAnalogNum): number {
		...
		let value: number;
		if (value_ANum == 1) {
			lightpin = AnalogPin.P0;
		} else if (value_ANum == 2) {
			lightpin = AnalogPin.P2;
		} else if (value_ANum == 3) {
			lightpin = AnalogPin.P3;
		}
	...
	export function Sound(value_ANum: mwAnalogNum): number {
		...
		let value: number;
		if (value_ANum == 1) {
			soundpin = AnalogPin.P0;
		} else if (value_ANum == 2) {
			soundpin = AnalogPin.P2;
		} else if (value_ANum == 3) {
			soundpin = AnalogPin.P3;
		}
